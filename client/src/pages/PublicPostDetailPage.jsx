...
export default function PublicPostDetailPage() {
  ...
  const fetchPost = async () => {
    try {
      setLoading(true);
      const res = await communityApi.getPublicPost(postId);
  ...
  const handleComment = async (e) => {
    ...
    setSubmitting(true);
    try {
      await communityApi.addPublicComment(postId, {
        content: newComment,
    ...
    <div className="post-detail-container">
      ...
      <div className="post-detail-card">
        ...
        <div style={{ display: "flex", gap: "15px", alignItems: "center", marginTop: "15px" }}>
          <div className="post-detail-stats" style={{ flex: 1, margin: 0 }}>
            <button
        ...
        <ShareModal
          ...
          shareUrl={`${window.location.origin}/community/public/posts/${post._id}`}
