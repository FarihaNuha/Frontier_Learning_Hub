...
## Corpus Check
- 107 files · ~85,544 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 703 nodes · 1146 edges · 40 communities (31 shown, 9 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f99d3a6`
...
### Community 0 - "App.jsx"
Cohesion: 0.07
Nodes (58): GlobalNotificationBell(), ShareModal(), StudentSidebar(), TeacherSidebar(), AuthContext, AuthProvider(), getActiveStatusSetting(), getSocketUrl() (+50 more)
...
Cohesion: 0.06
Nodes (29): Assignment, Course, deleteSubmission(), fs, { getIO }, Notification, path, previewService (+21 more)
