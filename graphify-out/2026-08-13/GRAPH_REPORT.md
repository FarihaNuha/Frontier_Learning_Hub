# Graph Report - UFTB_Moodle  (2026-08-13)

## Corpus Check
- 250 files · ~222,818 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1536 nodes · 2407 edges · 146 communities (104 shown, 42 thin omitted)
...
### Community 0 - "App.jsx"
Cohesion: 0.16
Nodes (3): StudentSidebar(), NotificationsPage(), StudentAssessmentPage()
...
Cohesion: 0.12
Nodes (30): addCourseComment(), addPublicComment(), CommunityComment, CommunityPost, ContactRequest, Course, deleteComment(), deleteMessage() (+22 more)
...
Cohesion: 0.04
Nodes (35): Assignment, Course, CourseImport, Notice, Result, Student, Teacher, User (+27 more)
...
Cohesion: 0.14
Nodes (12): GlobalNotificationBell(), TeacherSidebar(), useAuth(), AuthPage(), CourseAnalyticsPage(), CourseDashboard(), SettingsPage(), StudentAttendancePage() (+4 more)
...
Cohesion: 0.14
Nodes (14): createAuditLog(), graduateStudent(), promoteStudentsBatch(), { createAuditLog }, createCourseNotice(), createNotice(), deleteNotice(), { getIO } (+6 more)
...
### Community 73 - "axios"
Cohesion: 0.23
Nodes (16): uploadMarksheet(), createAssignment(), gradeSubmission(), createContactRequest(), createCoursePost(), createPublicPost(), respondToContactRequest(), sendMessage() (+8 more)
...
### Community 143 - "@testing-library/react"
Cohesion: 0.50
Nodes (3): ctrl, router, { verifyToken, checkRole }

### Community 144 - "courseRoutes.js"
Cohesion: 0.50
Nodes (3): ctrl, router, { verifyToken, checkRole }

## Knowledge Gaps
- **777 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `@opencode-ai/plugin`, `name`, `version` (+772 more)
...
- **Why does `api` connect `emailService.js` to `App.jsx`, `CommunityComment.js`, `User.js`, `examRoutes.js`, `react`, `useAuth`, `apiCache.js`, `upload.js`, `courseRoutes.js`, `ExamSubmission.js`?**
