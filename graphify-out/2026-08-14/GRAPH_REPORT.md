...
## Corpus Check
- 250 files · ~222,668 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1537 nodes · 2409 edges · 147 communities (107 shown, 40 thin omitted)
...
Cohesion: 0.11
Nodes (17): GlobalNotificationBell(), TeacherSidebar(), useAuth(), AuthPage(), CourseAnalyticsPage(), CourseDashboard(), MessagePage(), RTC_CONFIG (+9 more)
...
Cohesion: 0.15
Nodes (13): Adviser, approveAllPendingRegistrations(), CourseImport, createNotification(), Enrollment, linkOrCreateLmsCourse(), Payment, Registration (+5 more)
...
- **Why does `api` connect `emailService.js` to `App.jsx`, `User.js`, `examRoutes.js`, `react`, `useAuth`, `apiCache.js`, `upload.js`, `courseRoutes.js`?**
