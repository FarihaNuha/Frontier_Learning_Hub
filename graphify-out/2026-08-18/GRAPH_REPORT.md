...
## Corpus Check
- 250 files · ~222,723 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1536 nodes · 2402 edges · 146 communities (105 shown, 41 thin omitted)
...
Cohesion: 0.11
Nodes (18): GlobalNotificationBell(), TeacherSidebar(), useAuth(), AuthPage(), CourseAnalyticsPage(), CourseDashboard(), MessagePage(), RTC_CONFIG (+10 more)
