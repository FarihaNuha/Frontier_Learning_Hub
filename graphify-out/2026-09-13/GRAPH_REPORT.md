# Graph Report - UFTB_Moodle  (2026-08-18)

## Corpus Check
- 250 files · ~223,161 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1536 nodes · 2402 edges · 146 communities (106 shown, 40 thin omitted)
...
### Community 0 - "App.jsx"
Cohesion: 0.19
Nodes (5): StudentSidebar(), StudentAttendancePage(), StudentDashboard(), StudentExamPage(), api
...
### Community 4 - "User.js"
Cohesion: 0.11
Nodes (26): FilePreviewModal(), ShareModal(), CommentItem(), CommunityHub(), CreatePostModal(), EditPostModal(), getFileUrl(), PostCard() (+18 more)
...
Cohesion: 0.13
Nodes (15): dependencies, axios, jspdf-autotable, jszip, react-hot-toast, socket.io-client, @testing-library/dom, web-vitals (+7 more)
...
Cohesion: 0.11
Nodes (21): GlobalNotificationBell(), TeacherSidebar(), AuthContext, AuthProvider(), getActiveStatusSetting(), getSocketUrl(), useAuth(), AuthPage() (+13 more)
...
Cohesion: 0.08
Nodes (23): AcademicProfile, batchUpdateMarks(), CGPARecord, Course, CourseImport, createCorrectionRequest(), { getIO }, getStudentCorrectionRequests() (+15 more)
...
Cohesion: 0.23
Nodes (13): CourseListPage(), getCourseBanner(), StudentAssignmentPage(), TeacherAssignmentPage(), TeacherDashboard(), BACKEND_URL, fetchWithCache(), getCachedData() (+5 more)
...
Cohesion: 0.12
Nodes (11): mongoose, User, bcrypt, mongoose, userSchema, axios, dns, jwt (+3 more)
...
- **Why does `api` connect `App.jsx` to `User.js`, `examRoutes.js`, `emailService.js`, `apiCache.js`, `upload.js`, `courseRoutes.js`?**
