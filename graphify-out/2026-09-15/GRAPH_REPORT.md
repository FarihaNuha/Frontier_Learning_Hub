...
## Corpus Check
- 251 files · ~227,201 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1541 nodes · 2411 edges · 143 communities (106 shown, 37 thin omitted)
...
Cohesion: 0.08
Nodes (37): addCourseComment(), addPublicComment(), CommunityComment, CommunityPost, ContactRequest, Course, deleteComment(), deleteMessage() (+29 more)
...
Cohesion: 0.08
Nodes (22): AcademicProfile, CGPARecord, Course, CourseImport, createCorrectionRequest(), getAdminResults(), { getIO }, getStudentCorrectionRequests() (+14 more)
...
Cohesion: 0.10
Nodes (16): examSchema, mongoose, questionSchema, answerSchema, examSubmissionSchema, mongoose, Assignment, cron (+8 more)
...
Cohesion: 0.09
Nodes (25): checkRole(), jwt, User, verifyToken(), ctrl, router, { verifyToken, checkRole }, ctrl (+17 more)
...
Cohesion: 0.20
Nodes (10): batchUpdateMarks(), deleteDraftUpload(), parseOptionalNumber(), publishResultBatch(), requestCorrectionBatch(), ResultLog, submitResultToAdmin(), uploadResultExcel() (+2 more)
...
Cohesion: 0.22
Nodes (6): mongoose, teacherSchema, mongoose, Student, Teacher, User
